...
If you used the default CORS enabled domains while generating the project, `localhost.fastapi.com` was configured to be allowed. If you didn't, you will need to add it to the list in the variable `BACKEND_CORS_ORIGINS` in the `.env` file.

To configure it in your stack, follow the section **Change the development "domain"** below, using the domain `localhost.fastapi.com`.

After performing those steps you should be able to open: http://localhost.fastapi.com and it will be served by your stack in `localhost`.
...
Frontend: http://localhost.fastapi.com

Backend: http://localhost.fastapi.com/api/

Automatic Interactive Docs (Swagger UI): http://localhost.fastapi.com/docs

Automatic Alternative Docs (ReDoc): http://localhost.fastapi.com/redoc

Adminer: http://localhost.fastapi.com:8080

Traefik UI: http://localhost.fastapi.com:8090
